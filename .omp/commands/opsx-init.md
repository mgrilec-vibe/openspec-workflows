...
Initialize the project directory supplied as `$@` with APM, install the OpenSpec workflow package, verify the deployed skills, and create a private GitHub repository named after the directory.

**Input:** A project directory path. Its basename becomes the GitHub repository name.
